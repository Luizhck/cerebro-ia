...
Se for AÇÃO → retorne JSON. Se for CONVERSA → responda com texto. NUNCA recuse pedidos.
...
app.listen(PORT, () => console.log('🧠 Jarvis Llama 3.3 70B rodando na porta ' + PORT));
